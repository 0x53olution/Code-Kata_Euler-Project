...
namespace Kata011_LargestProductInAGrid
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ergebnis: " + product);
            Console.ReadLine();
        ...
        static int[,] ReadGrid()
        {
            //FileStream fs = new FileStream(Environment.CurrentDirectory + "\\GivenGrid.txt", FileMode.Open, FileAccess.Read);
            int rows = 0;
            int columns = 0;
            string line;
            string[] linePieces;
            StreamReader sr = new StreamReader(Environment.CurrentDirectory + "\\GivenGrid.txt");
            ...
            int[,] givenGrid = new int[rows, columns];
            ...
            while ((line = sr.ReadLine()) != null)
            {
                ...
                {
                    givenGrid[j, i] = int.Parse(linePieces[i]);
                }
                j++;
            }
            sr.Close();
